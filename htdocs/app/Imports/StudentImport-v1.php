    ...
    public function model(array $row){
        ...
        if(isset($this->data['course'])){
            ...
            if($stud_data && $stud_data->count()){
                ...
                Attendance::where('student',$stud_data->stud_id)->update(['course'=>$stud_data->course,'department'=>$stud_data->department,'year'=>$stud_data->current_year,'gender'=>$stud_data->gender,'academic_year'=>$stud_data->academic_year]);
                AccessControl::where('student',$stud_data->stud_id)->update(['course'=>$stud_data->course,'department'=>$stud_data->department,'current_year'=>$stud_data->current_year,'academic_year'=>$stud_data->academic_year]);
                AccessLogs::where('student',$stud_data->stud_id)->update(['course'=>$stud_data->course,'department'=>$stud_data->department,'current_year'=>$stud_data->current_year,'academic_year'=>$stud_data->academic_year]);
                Marks::where('student',$stud_data->stud_id)->update(['course'=>$stud_data->course,'department'=>$stud_data->department,'year'=>$stud_data->current_year,'academic_year'=>$stud_data->academic_year]);
                Notification::where('student',$stud_data->stud_id)->update(['course'=>$stud_data->course,'department'=>$stud_data->department,'year'=>$stud_data->current_year,'academic_year'=>$stud_data->academic_year]);
