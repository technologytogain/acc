...
class ReportController extends Controller{
	...
	/*	\App\Components\Common::sendNotification(11,5,1,'d9YmmIyzQjOGL8lRus020x:APA91bGvoXsFX9xCRiO81qo1Ylaee-jPhjH0xZgruxAaHy5ACQAfJeArslQoux75oCp0P6hr5Wvs-9KN3QV3ilovrJ8Ozudybi3jCbgfzCAoFmtuG3lKyP-QMWdyaqJCbzdmbwhaR29b','test title','test message from SAMS');
		...
		*/
		...
		$qry->each(function($data)use($period,$lunch_break){
			...
			if($data->p_one==1) $data->p_one='P'; elseif($data->p_one==2) $data->p_one='L'; elseif($lunch_break->order==1) $data->p_one="LB"; elseif($data->p_one_notification==1) $data->p_one="A"; else $data->p_one='';
			if($data->p_two==1) $data->p_two='P'; elseif($data->p_two==2) $data->p_two='L'; elseif($lunch_break->order==2) $data->p_two="LB"; elseif($data->p_two_notification==1) $data->p_two="A"; else $data->p_two='';
			if($data->p_three==1) $data->p_three='P'; elseif($data->p_three==2) $data->p_three='L'; elseif($lunch_break->order==3) $data->p_three="LB"; elseif($data->p_three_notification==1) $data->p_three="A"; else $data->p_three='';
			if($data->p_four==1) $data->p_four='P'; elseif($data->p_four==2) $data->p_four='L'; elseif($lunch_break->order==4) $data->p_four="LB"; elseif($data->p_four_notification==1) $data->p_four="A"; else $data->p_four='';
			if($data->p_five==1) $data->p_five='P'; elseif($data->p_five==2) $data->p_five='L'; elseif($lunch_break->order==5) $data->p_five="LB"; elseif($data->p_five_notification==1) $data->p_five="A"; else $data->p_five='';
			if($data->p_six==1) $data->p_six='P'; elseif($data->p_six==2) $data->p_six='L'; elseif($lunch_break->order==6) $data->p_six="LB"; elseif($data->p_six_notification==1) $data->p_six="A"; else $data->p_six='';
			if($data->p_seven==1) $data->p_seven='P'; elseif($data->p_seven==2) $data->p_seven='L'; elseif($lunch_break->order==7) $data->p_seven="LB"; elseif($data->p_seven_notification==1) $data->p_seven="A"; else $data->p_seven='';
			if($data->p_eight==1) $data->p_eight='P'; elseif($data->p_eight==2) $data->p_eight='L'; elseif($lunch_break->order==8) $data->p_eight="LB"; elseif($data->p_eight_notification==1) $data->p_eight="A"; else $data->p_eight='';
			if($data->p_nine==1) $data->p_nine='P'; elseif($data->p_nine==2) $data->p_nine='L'; elseif($lunch_break->order==9) $data->p_nine="LB"; elseif($data->p_nine_notification==1) $data->p_nine="A"; else $data->p_nine='';
			if($data->p_ten==1) $data->p_ten='P'; elseif($data->p_ten==2) $data->p_ten='L'; elseif($lunch_break->order==10) $data->p_ten="LB"; elseif($data->p_ten_notification==1) $data->p_ten="A"; else $data->p_ten='';
