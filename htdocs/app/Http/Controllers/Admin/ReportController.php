...
class ReportController extends Controller{
    ...
    public function punchdetails(Request $request){
        ...
        $data = Attendance::filter($request->all())->where('upgrade',0)->whereRaw('('.$qry.')')->orderBy('date', 'DESC')->orderBy('register_no','ASC');
    ...
    public function punchdownload(Request $request){        
        ...
        $attendance=Attendance::whereRaw('('.$qry.')')->where('upgrade',0)->orderBy('date', 'DESC')->orderBy('register_no','ASC')->get();
        $dataSet=[];
        $inc=1;
    ...
    public function presentdetails(Request $request){
        ...
        $data = Attendance::filter($request->all())->where('upgrade',0)->whereRaw('('.$qry.')')->whereRaw(' ( p_one=1 OR p_one=2 )')->orderBy('date', 'DESC')->orderBy('register_no','ASC');
        return DataTables::of($data)
            ->editColumn('student', function ($data){
                $student = Student::where('stud_id', $data->student)->first();
                if ($student) {
    ...
    public function presentdownload(Request $request){        
        ...
        $attendance=Attendance::whereRaw('('.$qry.')')->whereRaw(' ( p_one=1 OR p_one=2 ) ')->where('upgrade',0)->orderBy('date', 'DESC')->orderBy('register_no','ASC')->get();
        $dataSet=[];
        $inc=1;
        foreach($attendance as $key => $Data) {
            $student_name=Student::where('stud_id',$Data->student)->first()->name;
    ...
    public function dailyabsencedetails(Request $request){
        ...
        $data = Attendance::filter($request->all())->whereRaw('('.$qry.')')->where('upgrade',0)->whereRaw('( p_one=0 )')->orderBy('register_no', 'ASC');
        return DataTables::of($data)
            ->editColumn('student', function ($data){
                $student = Student::where('stud_id', $data->student)->first();
                if ($student) {
    ...
    public function dailyabsencedownload(Request $request){
       ...
       $attendance=Attendance::where('upgrade',0)->whereRaw('('.$qry.')')->whereRaw(' ( p_one=0 ) ')->orderBy('register_no','ASC')->get();
        $dataSet=[];
        $inc=1;
        foreach($attendance as $key => $Data) {
            $student_name=Student::where('stud_id',$Data->student)->first()->name;
    ...
    public function continuousabsencedetails(Request $request){
        ...
        $data = Attendance::whereRaw("($qry)")->where('upgrade',0)->whereRaw(' ( p_one=0 ) ')->orderBy('register_no','ASC')->orderBy('date','ASC');
        return DataTables::of($data)
            ->editColumn('student', function ($data){
                $student = Student::where('stud_id', $data->student)->first();
                if ($student) {
    ...
    public function continuousabsencedownload(Request $request){
       ...
       $attendance=Attendance::whereRaw("($qry)")->where('upgrade',0)->whereRaw(' ( p_one=0 ) ')->orderBy('register_no','ASC')->orderBy('date','ASC')->get();
        $dataSet=[];
        $exst=""; $inc=1;
        foreach($attendance as $key => $Data) {
            $student_name=Student::where('stud_id',$Data->student)->first()->name;
     ...
     public function monthly(Request $request){
        ...
        $attendance=Attendance::select('student')->whereRaw('DATE_FORMAT(date,"%m-%Y") ="'.$request->monthyear.'" ')->whereRaw('('.$qry.')')->groupBy('student')->orderBy('register_no','ASC')->paginate(10);
    ...
    public function monthlydownload(Request $request){        
        ...
        $attendance=Attendance::select('student')->whereRaw('DATE_FORMAT(date,"%m-%Y") ="'.$request->monthyear.'" ')->where('upgrade',0)->whereRaw($qry)->groupBy('student')->orderBy('register_no','ASC')->get();
