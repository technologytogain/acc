...
class StudentExport implements FromCollection, WithHeadings, WithProperties,WithEvents{
    ...
    public function registerEvents(): array{
       ...
       /* return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A2:M2')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
